...
{
	HAL_SPI_Transmit  ( &hspi3,  (uint8_t *) &byte, 1, 20) ;
}
...
void ssd1306Refresh(void)
{
  ...
  HAL_SPI_Transmit  ( &hspi3,  (uint8_t *) buffer_ol, sizeof(buffer), 200) ;
  #else
  HAL_SPI_Transmit  ( &hspi3,  (uint8_t *) buffer, sizeof(buffer), 200) ;
  #endif
